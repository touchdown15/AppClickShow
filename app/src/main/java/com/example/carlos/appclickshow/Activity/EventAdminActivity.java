...
public class EventAdminActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnFazerEvento = (Button) findViewById(R.id.btnFazerEvento);
        btnPesquisarEvento = (Button) findViewById(R.id.btnPesquisarEvento);


        btnFazerEvento.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentAbrirFazerEvento = new Intent(EventAdminActivity.this, CriarEventoActivity.class);
                startActivity(intentAbrirFazerEvento);
            }
        });
        ...
        btnPesquisarEvento.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentAbrirPesquisarEvento = new Intent(EventAdminActivity.this, LoggedActivity.class);
